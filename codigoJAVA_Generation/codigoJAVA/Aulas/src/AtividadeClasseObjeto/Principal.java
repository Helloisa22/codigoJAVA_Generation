...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.printf("O nome do cliente é %s\t o CPF é: %s O tamanho é: %d.\n", room.nome, room.cpf, room.tamanho);
		
		
		airplane.valor = 1300;
		airplane.nomeAviao = "Boeing";
		airplane.numero = 787;
		airplane.aviacao = "Viação Garcia";
		
		System.out.printf("O avião %s, n° %d, tem valor de %f, pertence a %s \n", airplane.nomeAviao, airplane.numero, airplane.valor, airplane.aviacao);
		...
		System.out.printf("Empresa TOTVS funcionário %s, cargo de %s, teve %d horas trabalhadas, com salario de %f \n",employee.nome, employee.cargo, employee.horasTrabalhadas, employee.salario);
		...
		Patient.numero = 057;
		Patient.situacao = "Estável";
		
		System.out.printf("Hospital Vila Celina paciente %s, doença %s, N° %d, a ala que ele está é %s, siatuação atual %s ",Patient.nome, Patient.doenca, Patient.numero, Patient.ala, Patient.situacao);
	}
