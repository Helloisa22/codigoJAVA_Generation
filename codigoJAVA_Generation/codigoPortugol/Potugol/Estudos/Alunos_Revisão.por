	...
	funcao inicio()
	{
		...
		se(escolher == 1){
			...
			se(sexos[i] == 'M' e notas[i] > 5){
				escreva("Matricula: ",matricula[i]," - Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ", notas[i], " - Aprovado\n")
			}
			senao se(sexos[i] == 'M' e notas[i] < 5){
				escreva("Matricula: ",matricula[i]," - Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ", notas[i], " - Reprovado\n")
			}
		...
		senao se(escolher == 2){
			para(inteiro i = 0; i<39;i++){
				se(sexos[i] == 'F' e notas[i] > 5){
						escreva("Matricula: ",matricula[i]," - Nome Aluna: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ", notas[i], " - Aprovada\n")
					
				}
				senao se(sexos[i] == 'F' e notas[i] < 5){
						escreva("Matricula: ",matricula[i]," - Nome Aluna: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ", notas[i], " - Reprovada\n")
		...
		senao se(escolher == 3){
			para(inteiro i=0 ; i<39 ; i++){
		 	...
		 	escreva("\n","Matricula: ",matricula[i]," - Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i] , " , Nota: ", notas[i], " - APROVADO")
		 	}
		 	senao se(notas[i] > 5 e sexos[i] == 'F') {
		 	escreva("\n","Matricula: ",matricula[i]," - Nome Aluna: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ",  notas[i], " - APROVADA")
		 	}
		 }
		}
		senao se(escolher == 4){
			para(inteiro i = 0; i<39; i++)
		{
			...
			senao se (sexos[i] == 'F' e notas[i] <= 5)
			escreva("Matricula: ",matricula[i]," - Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i] , " , Nota: ", notas[i], " - Reprovada\n")
		}
			...
			se(notaAluno == 1){
				para(inteiro i=0; i<39; i++){
					se(notas[i] > notaBase e sexos[i]=='M'){
						escreva("\nMatricula: ",matricula[i]," - Nome Aluno: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ", notas[i])
					}
					se(notas[i] > notaBase e sexos[i]=='F'){
						escreva("\nMatricula: ",matricula[i]," - Nome Aluna: ", alunos[i], "/ sexo - ", sexos[i], " , Nota: ", notas[i])
					}
